...
class Message {
  constructor(message) {
    ...
    this.date = moment(message.date);
    this.issuer_id_type = message.issuer_id_type;
    this.issuer_id_number = message.issuer_id_number;
    this.receiver_id_type = message.receiver_id_type;
    this.receiver_id_number = message.receiver_id_number;
  ...
  buildXml() {
    ...
    message[this.rootTag].NumeroCedulaEmisor = this.issuer_id_number;
    ...
    message[this.rootTag].NumeroCedulaReceptor = this.receiver_id_number;
  ...
  getPayload() {
    ...
    const payload = {
      ...
      emisor: {
        tipoIdentificacion: this.issuer_id_type,
        numeroIdentificacion: this.issuer_id_number,
      },
      receptor: {
        tipoIdentificacion: this.receiver_id_type,
        numeroIdentificacion: this.receiver_id_number,
      },
