class Receiver {
  ...
  generate() {
    ...
    if (this.id) obj.Identificacion = {Tipo: this.idType, Numero: this.id};
    if (this.foreignId) {
    ...
    if (this.phone) {
      obj.Telefono = {CodigoPais: "506", NumTelefono: this.phone};
    }
    if (this.fax) {
      obj.Fax = {CodigoPais: "506", NumTelefono: this.fax};
    }
    if (this.email) {
