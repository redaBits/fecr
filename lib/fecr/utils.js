module.exports = {
  ...
  parseVouchers(xml2js) {
    ...
    const issuer = {
      ...
      tradename: doc.Emisor[0].NombreComercial ?
        doc.Emisor[0].NombreComercial[0] : null,
    ...
    doc.DetalleServicio[0].LineaDetalle.forEach((item) => {
      const tmpItem = {
        ...
        commercialCode: item.CodigoComercial ?
          item.CodigoComercial[0].Codigo[0] : null,
    ...
    const summary = {
      ...
      vatReturned: doc.ResumenFactura[0].TotalIVADevuelto ?
        doc.ResumenFactura[0].TotalIVADevuelto[0] : null,
    ...
    if (doc.Receptor) {
      const receiver = {
        ...
        tradename: doc.Receptor[0].NombreComercial ?
          doc.Receptor[0].NombreComercial[0] : null,
        email: doc.Receptor[0].CorreoElectronico ?
          doc.Receptor[0].CorreoElectronico[0] : null,
        phone: doc.Receptor[0].Telefono ?
          doc.Receptor[0].Telefono[0].NumTelefono[0] : null,
      };
